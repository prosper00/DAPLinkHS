...
../src/Startup/system_ch32v30x.c 

S_UPPER_SRCS += \
../src/Startup/startup_ch32v30x_D8C.S 

OBJS += \
./src/Startup/core_riscv.o \
./src/Startup/startup_ch32v30x_D8C.o \
./src/Startup/system_ch32v30x.o 

S_UPPER_DEPS += \
./src/Startup/startup_ch32v30x_D8C.d 

C_DEPS += \
./src/Startup/core_riscv.d \
./src/Startup/system_ch32v30x.d 
...
src/Startup/%.o: ../src/Startup/%.S
	...
	riscv-none-embed-gcc -march=rv32imac -mabi=ilp32 -msmall-data-limit=8 -msave-restore -O1 -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections -fno-common -Wuninitialized  -g -x assembler-with-cpp -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -c -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
